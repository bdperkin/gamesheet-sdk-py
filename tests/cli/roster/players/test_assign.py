...
def test_roster_players_assign_coverage() -> None:
    ...
    with (
        ...
        patch("gamesheet_sdk.cli.commands.roster._assign_player_action", return_value=mock_player),
...
def test_roster_players_assign_error_handling() -> None:
    ...
    with (
        patch("gamesheet_sdk.cli.commands.roster.build_authenticated_session"),
        patch("gamesheet_sdk.cli.commands.roster._assign_player_action", side_effect=Exception("Test error")),
    ):
        result = runner.invoke(
            players_group,
            [
...
def test_roster_players_unassign_coverage() -> None:
    ...
    with (
        patch("gamesheet_sdk.cli.commands.roster.build_authenticated_session"),
        patch("gamesheet_sdk.cli.commands.roster._unassign_player_action"),
    ):
        result = runner.invoke(
            players_group,
            [
...
def test_roster_players_unassign_error_handling() -> None:
    ...
    with (
        patch("gamesheet_sdk.cli.commands.roster.build_authenticated_session"),
        patch(
            "gamesheet_sdk.cli.commands.roster._unassign_player_action",

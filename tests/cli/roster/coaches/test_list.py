...
from gamesheet_sdk.admin.cli.commands import coaches_group
...
def test_roster_coaches_list_coverage() -> None:
    ...
    with (
        ...
        patch(
            "gamesheet_sdk.admin.cli.commands.roster_coaches.run_action_or_exit",
            return_value=[],
        ),
        patch("gamesheet_sdk.admin.cli.commands.roster_coaches.render_list_command"),
    ):

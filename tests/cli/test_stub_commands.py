...
def test_roster_players_create_stub() -> None:
    ...
    result = CliRunner().invoke(players_group, ["create"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_roster_players_update_stub() -> None:
    ...
    result = CliRunner().invoke(players_group, ["update"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_roster_coaches_create_stub() -> None:
    ...
    result = CliRunner().invoke(coaches_group, ["create"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_roster_coaches_update_stub() -> None:
    ...
    result = CliRunner().invoke(coaches_group, ["update"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_teams_roster_players_create_stub() -> None:
    ...
    result = CliRunner().invoke(teams_roster_players_group, ["create"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_teams_roster_players_update_stub() -> None:
    ...
    result = CliRunner().invoke(teams_roster_players_group, ["update"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_teams_roster_coaches_get_stub() -> None:
    ...
    result = CliRunner().invoke(teams_roster_coaches_group, ["get"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_teams_roster_coaches_create_stub() -> None:
    ...
    result = CliRunner().invoke(teams_roster_coaches_group, ["create"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()
...
def test_teams_roster_coaches_update_stub() -> None:
    ...
    result = CliRunner().invoke(teams_roster_coaches_group, ["update"])
    assert result.exit_code == 1
    assert "not yet implemented" in result.output.lower()

...
def test_delete_calendar_event_raw_success() -> None:
    ...
    responses.add(
        responses.DELETE,
        f"{_CALENDAR_EVENTS_URL}/a1e62678-4d11-4968-bc95-ad2c047b6727",
        json={
            "success": True,
...
def test_delete_calendar_event_raw_unauthorized() -> None:
    ...
    responses.add(
        responses.DELETE,
        f"{_CALENDAR_EVENTS_URL}/evt-123",
        json={"error": "Unauthorized"},
        status=401,
    )
    responses.add(
...
def test_delete_calendar_occurrence_raw_success() -> None:
    ...
    responses.add(
        responses.DELETE,
        f"{_OCCURRENCE_URL}/25de04e6-9293-4b4c-8967-e9bdb0eab41d",
        json={
            "success": True,
...
def test_delete_event_all_occurrences() -> None:
    ...
    responses.add(
        responses.DELETE,
        f"{_CALENDAR_EVENTS_URL}/evt-series-1",
        json={
            "success": True,
            "data": {"message": "Calendar event and all occurrences deleted successfully"},
        },
...
def test_delete_practice_all_occurrences() -> None:
    ...
    responses.add(
        responses.DELETE,
        f"{_CALENDAR_EVENTS_URL}/prac-series-1",
        json={
            "success": True,
            "data": {"message": "Calendar event and all occurrences deleted successfully"},
        },
...
def test_update_calendar_occurrence_raw_with_future() -> None:
    ...
    responses.add(
        responses.PUT,
        f"{_OCCURRENCE_URL}/{occ_id}?updateFuture=true",
        json={
            "success": True,
            "data": {
                "id": occ_id,

...
**Purpose**: Main spider implementation
**Type**: Executable Python script
**Dependencies**: `playwright`, `gamesheet_sdk`
...
**Entry Point**: `main(argv)` function
**Classes**:
...
**Purpose**: Analysis and reporting tool for spider output
**Type**: Executable Python script
...
**Purpose**: Convenience wrapper demonstrating common patterns
**Type**: Bash shell script
**Dependencies**: `spider_season.py`
...
4. All CLI options reference
5. Output format specification
6. How it works (architecture)
7. Mutation discovery heuristics
8. Limitations
9. Development notes
...
**Purpose**: Directory structure and file reference
**Audience**: New contributors, maintainers

## Example Data (1 file)

### example-output.json (71 lines)
**Purpose**: Sample spider output demonstrating structure
**Type**: JSON data file

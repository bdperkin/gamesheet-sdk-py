...
"""CLI constants for the GameSheet admin CLI."""
...
CLI_COMMAND_NAME = "gamesheet-admin"
CLI_COMMAND_LOGIN = "gamesheet-admin login"

# Help text fragments
HELP_AUTH_REQUIRED = "Requires authentication (run 'gamesheet-admin login' first)."

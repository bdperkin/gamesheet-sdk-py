...
from gamesheet_sdk.games.helpers import _make_request, validate_game_type
from gamesheet_sdk.games.models import Game, ScheduledGame
...
def create_scheduled_game(
    ...
    from gamesheet_sdk.games.broadcasters import validate_broadcaster_key
    from gamesheet_sdk.games.locations import validate_location

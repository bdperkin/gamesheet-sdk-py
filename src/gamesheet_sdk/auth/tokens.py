...
def load_refresh_token(config: Config) -> str | None:
    ...
    :class:`~gamesheet_sdk.auth.session.AuthenticatedSession`.
...
def refresh_access_token(
    ...
    *,
    ...
    POSTs to :data:`~gamesheet_sdk.auth.constants.REFRESH_URL` with
    ...
    :class:`~gamesheet_sdk.auth.session.AuthenticatedSession`'s retry path without
    recursing.

...
"""Calendar events CLI commands for GameSheet teams."""
...
@click.option(
    ...
    type=str,
    default="",
    help="Event notes or description.",
)
@click.option(
    "--timezone",
    type=str,
...
@click.option(
    ...
    required=True,
    help="Event occurrence identifier.",
)
@click.option(
    "--availability",
...
@click.option(
    ...
    envvar="GAMESHEET_EVENT_ID",
    required=True,
    help="Identifier of the event or occurrence to delete.",
)
@click.option(
    "--force",
    is_flag=True,
...
def events_delete_command(
    ...
    *,
    ...
    confirm_delete_or_abort("event", event_id, force=force)
...
@click.option(
    ...
    envvar="GAMESHEET_EVENT_ID",
    required=True,
    help="Identifier of the event occurrence to update.",
)
@occurrence_update_options
@common_output_options
@get_fields_option
